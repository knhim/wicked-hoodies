...
export default function CartSummary(props) {
  ...
  if (cart.length === 0) {
    return (
      <>
        <h2 className="pointer my-2" onClick={() => props.setView('catalog', { params: {} })}>&lt; Back to catalog</h2>
    ...
    return (
      <>
        <h2 className="my-1" style={{ cursor: 'pointer' }} onClick={() => props.setView('catalog', { params: {} })}>&lt; Back to catalog</h2>
        { cartItems}
